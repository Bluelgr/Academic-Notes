...
\ee
which says the inner product of $|A\ra$ and $|B\ra$ does not change with time, or the inner product is conserved.\\
...
\be
|\Psi(\ep)\ra=\hat U(\ep) |\Psi(0)\ra = |\Psi(0)\ra-i\ep|\Psi(0)\ra,
\ee
