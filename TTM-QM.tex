...
The phase frequency means how much phase of a space point varies when a unit time passes. It's just $2\pi$ times the frequency, since when a wavelength passes through, a full cycle in phase space is completed.
